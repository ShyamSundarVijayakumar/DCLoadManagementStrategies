...
//	System.out.printf("server cpu .. %.2f | ram ..%.2f | total.. %.2f\n",serverCPUUtil, serverRamUtil, serverUsage);
...
//	resourceUtilization(serverUtil);//------>gets the overall datacenter utlization
	slaViolations();
