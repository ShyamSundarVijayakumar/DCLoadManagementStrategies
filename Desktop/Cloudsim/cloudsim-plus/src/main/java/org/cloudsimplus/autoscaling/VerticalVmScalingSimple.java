...
public class VerticalVmScalingSimple extends VmScalingAbstract implements VerticalVmScaling {
    public static ResourceScaling resourceScaling;
    ...
    @Override
    public VerticalVmScaling setUpperThresholdFunction(final Function<Vm, Double> upperThresholdFunction) {
    ...
    @Override
    public VerticalVmScaling setLowerThresholdFunction(final Function<Vm, Double> lowerThresholdFunction) {
        validateFunctions(lowerThresholdFunction, upperThresholdFunction);
    ...
    @Override
    public boolean requestUpScalingIfPredicateMatches(final VmHostEventInfo evt) { //final removed----------------------------------------------------------
