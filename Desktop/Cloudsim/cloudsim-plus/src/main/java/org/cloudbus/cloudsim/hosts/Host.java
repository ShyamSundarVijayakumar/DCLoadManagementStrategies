...
public interface Host extends Machine, Comparable<Host> {
    ...
    /**
     * Gets the Host description, which is an optional text
     * which one can use to provide details about this of this Host.
     * @return
     */
    String getDescription();

    /**
     * Sets the Host description, which is an optional text
     * which one can use to provide details about this of this host.
     * @param description the host description to set
     * @return
     */
    Host setDescription(String description);
}
